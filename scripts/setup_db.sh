#!/usr/bin/env bash
# Builds the raw/staging/analytics/streaming schema and tables.
...
echo "==> Creating streaming tables..."
docker exec -i healthcare_pg psql -U healthcare -d healthcare_db < sql/06_streaming_tables.sql
