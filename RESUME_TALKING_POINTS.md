...
## Resume bullets (pick the ones matching the job posting's keywords)

> Designed and built a 7-stage healthcare data pipeline (Postgres, dbt,
> Airflow, MinIO/S3, PySpark, Kafka) migrating a normalized OLTP schema
> to a dimensional star schema, fully containerized and reproducible
...
> healthcare events (admissions, lab results, vital signs) into a
> warehouse table, using consumer groups and idempotent writes.
